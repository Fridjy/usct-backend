...
import static global.care.usct.configuration.AuthoritiesConstants.ENROLLMENT_OFFICER;
import static global.care.usct.configuration.AuthoritiesConstants.PAYMENT_OFFICER;
import static global.care.usct.configuration.AuthoritiesConstants.REGISTRY_OFFICER;
...
import global.care.usct.util.JwtHttpMessageConverter;
import global.care.usct.util.OAuth2JwtUserRequestEntityConverter;
    ...
    for (var authority : authorities) {
      if (authority instanceof OidcUserAuthority oidc) {
        ...
        return switch (username) {
          case "jason.hans@care.example.org" -> Set.of(
              new SimpleGrantedAuthority("ROLE_" + REGISTRY_OFFICER));
          case "max.bob@care.example.org" -> Set.of(
              new SimpleGrantedAuthority("ROLE_" + ENROLLMENT_OFFICER));
          case "susie.may@care.example.org" -> Set.of(
